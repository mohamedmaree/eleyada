...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.pregnantweeksinfos.create') }}" 
    deletebutton="{{ route('admin.pregnantweeksinfos.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/pregnantweeksinfos')])
@endsection

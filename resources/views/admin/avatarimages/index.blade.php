...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.avatarimages.create') }}" 
    deletebutton="{{ route('admin.avatarimages.deleteAll') }}" 
    :searchArray="[
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/avatarimages')])
@endsection

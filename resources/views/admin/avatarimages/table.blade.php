<div class="position-relative">
    ...
    <table class="table " id="tab">
        ...
        <tbody>
            @foreach ($avatarimages as $avatarimages)
                <tr class="delete_row">
                    <td class="text-center">
                        <label class="container-checkbox">
                        <input type="checkbox" class="checkSingle" id="{{ $avatarimages->id }}">
                        <span class="checkmark"></span>
                        </label>
                    </td>
                    ...
                    <td class="product-action"> 
                        ...
                        <span class="action-edit text-primary"><a href="{{ route('admin.avatarimages.edit', ['id' => $avatarimages->id]) }}"><i class="feather icon-edit"></i></a></span>
                        <span class="delete-row text-danger" data-url="{{ url('admin/avatarimages/' . $avatarimages->id) }}"><i class="feather icon-trash"></i></span>
                    </td>
                </tr>
            @endforeach
        </tbody>
...
@if ($avatarimages->count() > 0 && $avatarimages instanceof \Illuminate\Pagination\AbstractPaginator )

        ...
        <div class="col-12">
            <div class="card">
                {{-- <div class="card-header">
                    <h4 class="card-title">{{__('admin.add') . ' ' . __('admin.training')}}</h4>
                </div> --}}
                <div class="card-content">
                    <div class="card-body">
                        <form  method="POST" action="{{route('admin.trainings.store')}}" class="store form-horizontal" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                       ...
                                       <div class="tab-content">
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="link_to_order" class="form-control" placeholder="{{ __('admin.link_to_order') }}" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-12">
